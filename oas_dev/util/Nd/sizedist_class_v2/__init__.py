...
class Sizedistribution:
    ...
    def __init__(self, case_name, from_time, to_time, dlim_sec, isSectional, time_res,
                 ...
                 nr_bins=5, print_stat=False, model_name='NorESM', history_field='.h0.', locations=constants.locations,
    ...
    def compute_sizedist_mod_tot(self):
        ...
        CHUNKS = {'diameter':20}
        ds = xr.open_mfdataset(fl, combine='by_coords', parallel=True, chunks=CHUNKS)  # .isel(diameter=slice(0,30))#.squeeze()
