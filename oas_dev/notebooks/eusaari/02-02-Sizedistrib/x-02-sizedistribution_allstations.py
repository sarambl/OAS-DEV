...
# %%
# Case names:
cases_sec = ['SECTv21_ctrl']#,'SECTv11_redSOA_LVnuc','SECTv11_incBVOC']#'PD_SECT_CHC7_diur_ricc']#, 'PD_SECT_CHC7_diurnal']# , 'PD_SECT_CHC7_diur_ricc_incC']
        ...
        for ii in range(nr_row):
            for jj in range(nr_col):
                ...
                if jj!=0:
                    ...
                    axs_nf[ii,jj].set_ylabel('dN/dlog$_{10}$D [cm$^2$]')
...
# %%
plot_grid(dic_clean,subs = 'WIN',  ylim=[0,8e3])
