...
cases_orig =[]#'noSECTv21_default']#,'noSECTv21_ox_ricc']#'noSECTv11_ctrl_fbvoc'] #/no SECTv11_ctrl
...
def get_fn_tmp(case, from_t, to_t):
    return path_tmp + '%s_%s-%s_concat_dNdlogDs_.nc'%(case,from_t,to_t)
def get_fn_tmp_station(case,station, from_t, to_t):
    return path_tmp + '%s_%s_%s-%s_concat_dNdlogDs.nc'%(case, station,from_t,to_t)
cases_loaded=[]
# %%
